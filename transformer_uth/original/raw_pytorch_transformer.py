...
if __name__ == "__main__":
    ...
    # Set UNK_IDX as the default index. This index
    # is returned when the token is not found.
    # If not set, it throws RuntimeError when the
    # queried token is not found in the Vocabulary.
    for ln in [SRC_LANGUAGE, TGT_LANGUAGE]:
